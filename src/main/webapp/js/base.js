(function (a, b) {
    ...
    p.Callbacks = function (a) {
        ...
        n.setAttribute("className", "t"), n.innerHTML = "  <link/><table></table><a href='/'>a</a><input type='checkbox'/>", c = n.getElementsByTagName("*"), d = n.getElementsByTagName("a")[0], d.style.cssText = "top:1px;float:left;opacity:.5";
